 ...
 *  Author: Oscar Mendez
 *  Course: COMP-003A
 *  Purpose: Replicating object-oriented programming concepts for week 6
 *  
 */
namespace COMP003A.Assignment6
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            // then you can simplify the value assignment using the syntaxe below
